    ...
    ui(new Ui::drugExapnder)
{
    ...
    connect(ui->tableView,SIGNAL(clicked(QModelIndex)),this,SLOT(load(QModelIndex)));
    ...
    connect(ui->shortcut,SIGNAL(textChanged(QString)),this,SLOT(setFilter(QString)));
...
void drugExapnder::on_closeButton_clicked()
{
    this->close();
}
