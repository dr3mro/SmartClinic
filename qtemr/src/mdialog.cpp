...
void mDialog::toggleVisualEffects(bool b) { enableVisualEffects = b; }

bool mDialog::getVisualEffectStatus() { return enableVisualEffects; }
...
void mDialog::onFadeOutFinished() { QDialog::done(mResult); }
