...
List_style_widget::List_style_widget(QWidget *parent)
    : StyleEditorWidget(parent), ui(new Ui::List_style_widget) {
  ui->setupUi(this);
  ui->selected_item_color_button->m_connect(this, ui->selected_item_color_text);
  ui->toolbutton_background_color_button->m_connect(
      this, ui->toolbutton_background_color_text);
  ui->messagebox_text_color_button->m_connect(this,
                                              ui->messagebox_text_color_text);
  ui->messagebox_background_color_button->m_connect(
      this, ui->messagebox_background_color_text);
}

List_style_widget::~List_style_widget() { delete ui; }
...
mStyler::List List_style_widget::getStyle() {
  ...
  list.messagebox_background_color =
      ui->messagebox_background_color_text->text();
...
void List_style_widget::putStyle(const mStyler::List &list) {
  ...
  ui->messagebox_background_color_text->setText(
      list.messagebox_background_color);
