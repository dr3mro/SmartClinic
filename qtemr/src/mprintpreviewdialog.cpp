...
mPrintPreviewDialog::mPrintPreviewDialog(QWidget *parent)
...
// void mPrintPreviewDialog::setPageOrientation(const QPrinter::Orientation
// &_orientation)
//{
...
mPrintPreviewDialog::~mPrintPreviewDialog() { delete printShortcut; }
