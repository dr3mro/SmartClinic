...
//        QString State;
    ...
    void createNewVisit(int ID, QString previous , const QDateTime &datetime, const QDate &followUpDate, int visitType, double visitPrice, DrugsItemModel *drugsModel, InvestModel *investModel, sqlExtra *sqlextra);
