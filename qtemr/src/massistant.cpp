...
void mAssistant::tweakRegisterTable()
{
  ...
  for(int i=0 ; i <= servicesCount ; ++i ){
      ui->cashTableView->horizontalHeader()->setSectionResizeMode(i+5, QHeaderView::ResizeToContents);
    }
  ...
  ui->cashTableView->horizontalHeader()->setSectionResizeMode(4, QHeaderView::ResizeToContents);
  ui->cashTableView->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Stretch);
  ui->cashTableView->horizontalHeader()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
...
void mAssistant::onAgendaModelLoaded()
{
  ...
  ui->agendaTableView->horizontalHeader()->setSectionResizeMode(2, QHeaderView::ResizeToContents);
  ui->agendaTableView->horizontalHeader()->setSectionResizeMode(1, QHeaderView::Stretch);
  ui->agendaTableView->horizontalHeader()->setSectionResizeMode(0, QHeaderView::ResizeToContents);
