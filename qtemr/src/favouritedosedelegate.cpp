...
favouriteDoseDelegate::favouriteDoseDelegate(QWidget *parent)
    : QItemDelegate(parent),
      connectionName(QString("favoriteDelegate_%1")
...
QWidget *favouriteDoseDelegate::createEditor(QWidget *parent,
...
void favouriteDoseDelegate::setEditorData(QWidget *editor,
                                          const QModelIndex &index) const {
...
void favouriteDoseDelegate::setModelData(QWidget *editor,
...
void favouriteDoseDelegate::updateEditorGeometry(
