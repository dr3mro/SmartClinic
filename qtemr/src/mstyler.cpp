...
void mStyler::saveStyle(const QString &styleName,
                        const mStyler::Style &_style) {
  ...
  styler.setValue(_th_border_color_diabled,
                  _style.button.border_color_disabled);
  ...
  styler.setValue(_th_selected_item_text_color,
                  _style.list.selected_item_text_color);
  styler.setValue(_th_messagebox_background_color,
                  _style.list.messagebox_background_color);
...
mStyler::Style mStyler::getStyle(const QString &theme) {
  ...
  style.button.border_color_normal =
      styler.value(_th_border_color_normal).toString();
  style.button.border_color_hover =
      styler.value(_th_border_color_hover).toString();
  style.button.border_color_focus =
      styler.value(_th_border_color_focus).toString();
  style.button.border_color_disabled =
      styler.value(_th_border_color_diabled).toString();
  ...
  style.input.border_color_normal =
      styler.value(_th_border_color_normal).toString();
  style.input.border_color_hover =
      styler.value(_th_border_color_hover).toString();
  style.input.border_color_focus =
      styler.value(_th_border_color_focus).toString();
  style.input.border_color_disabled =
      styler.value(_th_border_color_diabled).toString();
  ...
  style.elementText.color_disabled =
      styler.value(_th_color_disabled).toString();
  ...
  styler.beginGroup(_th_list);
  style.list.selected_item_color =
      styler.value(_th_selected_item_color).toString();
  style.list.selected_item_text_color =
      styler.value(_th_selected_item_text_color).toString();
  style.list.messagebox_background_color =
      styler.value(_th_messagebox_background_color).toString();
  style.list.toolbutton_color_normal =
      styler.value(_th_toolbutton_color).toString();
  style.list.messagebox_text_color =
      styler.value(_th_messagebox_text_color).toString();
  style.list.enable3D = styler.value(_th_enable3D).toBool();
  styler.endGroup();
  return style;
}

void mStyler::setStyle(const QString &_style) { current_style = _style; }

QString mStyler::getCurrentStyle() { return current_style; }
...
QString mStyler::getThemePath(QString theme) {
  ...
  return QString("%1\\themes\\%2.ini")
      .arg(dataIOhelper::getCurrentFolder())
      .arg(theme);
}
...
QStringList mStyler::getNonPackagedThemes() {
  ...
  foreach (QString t,
           QDir(QString("%1\\themes\\").arg(dataIOhelper::getCurrentFolder()))
               .entryList()) {
    if (t.endsWith(".ini"))
...
mStyler::Style &mStyler::getLoadedStyle() { return style; }

QString mStyler::getStyleSheet() {
  Style mStyle = getStyle(current_style);
  QString stylebase =
      dataIOhelper::getTextFileContents(":/Themes/styleSheet.css");
  ...
  theme << qMakePair(QString("window_top_color"), mStyle.window.top_color)
        ...
        << qMakePair(QString("window_border_width"),
                     QString::number(mStyle.window.border_width))
        << qMakePair(QString("window_border_radius"),
                     QString::number(mStyle.window.border_radius))
        << qMakePair(QString("subWindow_top_color"), mStyle.subwindow.top_color)
        << qMakePair(QString("subWindow_bottom_color"),
                     mStyle.subwindow.bottom_color)
        << qMakePair(QString("subWindow_border_color"),
                     mStyle.subwindow.border_color)
        << qMakePair(QString("subWindow_border_width"),
                     QString::number(mStyle.subwindow.border_width))
        << qMakePair(QString("subWindow_border_radius"),
                     QString::number(mStyle.subwindow.border_radius))
        ...
        << qMakePair(QString("button_color_disabled"),
                     mStyle.button.color_disabled)
        << qMakePair(QString("button_color_warning"),
                     mStyle.button.color_warning)
        << qMakePair(QString("button_color_error"), mStyle.button.color_error)
        << qMakePair(QString("button_border_color_normal"),
                     mStyle.button.border_color_normal)
        << qMakePair(QString("button_border_color_hover"),
                     mStyle.button.border_color_hover)
        << qMakePair(QString("button_border_color_focus"),
                     mStyle.button.border_color_focus)
        << qMakePair(QString("button_border_color_diabled"),
                     mStyle.button.border_color_disabled)
        << qMakePair(QString("button_border_width"),
                     QString::number(mStyle.button.border_width))
        << qMakePair(QString("button_border_radius"),
                     QString::number(mStyle.button.border_radius))
        ...
        << qMakePair(QString("input_color_disabled"),
                     mStyle.input.color_disabled)
        ...
        << qMakePair(QString("input_border_color_normal"),
                     mStyle.input.border_color_normal)
        << qMakePair(QString("input_border_color_hover"),
                     mStyle.input.border_color_hover)
        << qMakePair(QString("input_border_color_focus"),
                     mStyle.input.border_color_focus)
        << qMakePair(QString("input_border_color_diabled"),
                     mStyle.input.border_color_disabled)
        << qMakePair(QString("input_border_width"),
                     QString::number(mStyle.input.border_width))
        << qMakePair(QString("input_border_radius"),
                     QString::number(mStyle.input.border_radius))
        << qMakePair(QString("elementText_color_normal"),
                     mStyle.elementText.color_normal)
        << qMakePair(QString("elementText_color_hover"),
                     mStyle.elementText.color_hover)
        << qMakePair(QString("elementText_color_focus"),
                     mStyle.elementText.color_focus)
        << qMakePair(QString("elementText_color_disabled"),
                     mStyle.elementText.color_disabled)
        << qMakePair(QString("elementText_color_warning"),
                     mStyle.elementText.color_warning)
        << qMakePair(QString("elementText_color_error"),
                     mStyle.elementText.color_error)
        << qMakePair(QString("inputText_color_normal"),
                     mStyle.inputText.color_normal)
        << qMakePair(QString("inputText_color_hover"),
                     mStyle.inputText.color_hover)
        << qMakePair(QString("inputText_color_focus"),
                     mStyle.inputText.color_focus)
        << qMakePair(QString("inputText_color_disabled"),
                     mStyle.inputText.color_disabled)
        << qMakePair(QString("inputText_color_warning"),
                     mStyle.inputText.color_warning)
        << qMakePair(QString("inputText_color_error"),
                     mStyle.inputText.color_error)
        << qMakePair(QString("list_selected_item_color"),
                     mStyle.list.selected_item_color)
        << qMakePair(QString("messagebox_background_color"),
                     mStyle.list.messagebox_background_color)
        << qMakePair(QString("messagebox_text_color"),
                     mStyle.list.messagebox_text_color)
        << qMakePair(QString("toolbutton_color_normal"),
                     mStyle.list.toolbutton_color_normal)
        << qMakePair(QString("selected_item_text_color"),
                     mStyle.list.selected_item_text_color)
        << qMakePair(QString("background_Flat_3D_hover"),
                     getBackground(mStyle.button.color_hover))
        << qMakePair(QString("background_Flat_3D_focus"),
                     getBackground(mStyle.button.color_focus))
        << qMakePair(QString("background_Flat_3D_disabled"),
                     getBackground(mStyle.button.color_disabled))
        << qMakePair(QString("background_Flat_3D"),
                     getBackground(mStyle.button.color_normal));
