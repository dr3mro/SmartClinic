...
addSiblings::addSiblings(int row, sqlBase::Sibling sibling, QWidget *parent,
                         bool edit)
    : QDialog(parent),
  ...
  ui->setupUi(this);
  connect(ui->addSibling, &QPushButton::clicked, this,
          &addSiblings::onAddSibling_clicked);
  connect(ui->editSibling, &QPushButton::clicked, this,
          &addSiblings::onEditSibling_clicked);
  connect(ui->closeButton, &QPushButton::clicked, this,
          &addSiblings::onCloseButton_clicked);
  clean();
  ui->addSibling->setHidden(edit);
  ui->editSibling->setVisible(edit);
  if (edit) {
    ui->dateOfBirth->setDate(
        QDate::fromString(sibling.DateOfBirth, "dd/MM/yyyy"));
...
void addSiblings::makeReadWrite(bool rw) { setEnabled(rw); }
