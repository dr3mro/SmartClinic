...
conditionsEdit::conditionsEdit(QWidget *parent)
    : QDialog(parent), ui(new Ui::conditionsEdit) {
  ui->setupUi(this);
...
int conditionsEdit::getModelLength() { return proxy_model->rowCount(); }

void conditionsEdit::on_lineEdit_returnPressed() { on_buttonAdd_clicked(); }
