...
class richTextEditor : public QWidget {
 ...
 public:
  ...
  void syncFontPoint(QString font, int point, bool bold, bool italic,
                     bool underLine, bool strike, bool highlight,
                     bool alignLeft, bool alignCenter, bool alignRight,
                     bool upper);
  ~richTextEditor();
