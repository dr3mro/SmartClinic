...
m_ClickableLabel::m_ClickableLabel(QWidget *parent, Qt::WindowFlags f):QLabel(parent,f)
{

}

m_ClickableLabel::m_ClickableLabel(const QString &text, QWidget *parent, Qt::WindowFlags f):QLabel(text,parent,f)
{
...
QString m_ClickableLabel::getPhoneNumber()
{
    return phoneNumber;
}
