...
button_input_widget::button_input_widget(QWidget *parent)
    : StyleEditorWidget(parent), ui(new Ui::button_input_widget) {
  ui->setupUi(this);
  ...
  ui->border_color_diabled_button->m_connect(this,
                                             ui->border_color_diabled_text);
}

button_input_widget::~button_input_widget() { delete ui; }
