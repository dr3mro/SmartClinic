...
class visitsBox : public mDialog {
 ...
 private:
  ...
  void setFollowDateTooltip(const int &selectedDateFollowUps,
                            const QDate &date);
  ...
  //////////////////////////////////
  int suggestedVisitType =
      0;  // for remote assistant created patient to modify this
  mSettings::Roshetta getRoshetta();
  void roshettaDrugsfiller(QList<mSettings::drug> &drugs,
                           DrugsItemModel *drugsModel, bool alteredDrugsOnly);
