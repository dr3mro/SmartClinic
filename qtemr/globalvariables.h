...
#define MinorVer 8
#define xVer 5
#define APPVERSION "3.8.5"
#define APPNAME "Smart Clinic"
#define APPNAMEVER "Smart Clinic 3.8.5"
...
#define updateInfo "https://dr3mro.000webhostapp.com/update"
...
#define exeBackUp "backup/~smartClinic2.exe"
