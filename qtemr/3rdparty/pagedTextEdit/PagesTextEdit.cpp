...
void PagesTextEdit::paintPageNumbers()
{
	...
	if (m_usePageMode && !m_pageMetrics.pxPageMargins().isNull() && m_showPageNumbers) {
		...
		//
        // The beginning of the field must take into account the offset of the scrollbar
		//
		...
		//
        // Top margin of the first page on the screen when the previous page is not visible
		//
