...
void mSortFilterProxyModel::setForm(QString form)
{
    Form = form;
}
...
bool mSortFilterProxyModel::filterAcceptsRow(int source_row, const QModelIndex &source_parent) const
{
    ...
    if ( Category == "All Drugs" && Manufacturer == "All Companies" && Form == "All Forms")
    {
    ...
    if ( tCategory == Category && tManufacturer == Manufacturer && Form == "All Forms")
    {
        return QSortFilterProxyModel::filterAcceptsRow(source_row,source_parent);
    }

    if ( tCategory == Category && Manufacturer == "All Companies" && tForm == Form)
    {
        return QSortFilterProxyModel::filterAcceptsRow(source_row,source_parent);
    }
    if ( tCategory == Category && Manufacturer == "All Companies" && Form == "All Forms")
    {
        return QSortFilterProxyModel::filterAcceptsRow(source_row,source_parent);
    }

    if ( Category == "All Drugs" && tManufacturer == Manufacturer && tForm == Form)
    {
        return QSortFilterProxyModel::filterAcceptsRow(source_row,source_parent);
    }

    if ( Category == "All Drugs" &&  Manufacturer == "All Companies" && tForm == Form)
    {
        return QSortFilterProxyModel::filterAcceptsRow(source_row,source_parent);
    }
    if ( Category == "All Drugs" &&  Manufacturer == tManufacturer && Form == "All Forms")
    {
        return QSortFilterProxyModel::filterAcceptsRow(source_row,source_parent);
    }
    return false;
